...
export function Livro() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Recomendação de Anime</Text>
      <View style={styles.form}>
        <Text style={styles.label}>Informe suas preferências:</Text>
        <TextInput
          placeholder="Genero do Anime"
          style={styles.input}
        />
        <TextInput
        ...
        />
        <TextInput
          placeholder="Produtora favorita"
          style={styles.input}
        />
      </View>
      ...
      <ScrollView style={styles.containerScroll} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24, marginTop: 4 }}>
        ...
        <View style={styles.content}>
          <Text style={styles.title}>Te recomendamos esses animes:</Text>
        </View>
      </ScrollView>
    </View>
  );
